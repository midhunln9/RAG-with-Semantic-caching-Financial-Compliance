...
from Ingestion.src.splitter import RecursiveCharacterTextSplitterMethod
from Ingestion.repositories.file_repo import FileRepo
...
async def main():
    ...
    logger.info(
        ...
        f"(batch_size={pinecone_config.batch_size})"
    )
